...
inline U64 operator&(Square s, U64 u) { return square_bb[s] & u; }
...
inline U64 shift(U64 bb, const Dir D) { return D == N ? bb << 8 : bb >> 8; }
...
inline void clear_bit(U64 &bb, int dst) { bb &= ~(square_bb[dst]); }

inline void set_bit(U64 &bb, int dst) { bb |= square_bb[dst]; }
