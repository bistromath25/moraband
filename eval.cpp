...
Score PAWN_WEIGHT = S(100, 151);
Score KNIGHT_WEIGHT = S(420, 404);
Score BISHOP_WEIGHT = S(424, 427);
Score ROOK_WEIGHT = S(678, 736);
Score QUEEN_WEIGHT = S(1323, 1347);
...
Score PAWN_PASSED_CANDIDATE = S(12, 60);
Score PAWN_CONNECTED = S(16, 35);
Score PAWN_ISOLATED = S(-4, 15);
Score PAWN_DOUBLED = S(-9, 15);
Score PAWN_FULL_BACKWARDS = S(-25, 13);
Score PAWN_BACKWARDS = S(-21, 15);
Score PAWN_SHIELD_CLOSE = S(10, 0);
Score PAWN_SHIELD_FAR = S(8, 0);
Score PAWN_SHIELD_MISSING = S(-20, 0);
Score STRONG_PAWN_ATTACK = S(-43, -38);
Score WEAK_PAWN_ATTACK = S(-25, -10);
Score HANGING = S(-2, 5);
Score KNIGHT_PAWN_PENALTY = S(-3, 19);
Score ROOK_PAWN_BONUS = S(1, 21);

Score BISHOP_PAIR = S(90, 115);
Score BAD_BISHOP = S(-6, 0);
Score TRAPPED_ROOK = S(-25, -50);
Score ROOK_OPEN_FILE = S(50, 35);
Score ROOK_ON_SEVENTH_RANK = S(40, 20);
Score KNIGHT_OUTPOST = S(66, 30);
Score BISHOP_OUTPOST = S(45, 25);
