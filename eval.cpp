...
Score KNIGHT_MOBILITY[9] = {
    S(-32, -42), S(-16, -20), S(6, 5), S(12, 19), S(19, 20),
    S(24, 31), S(26, 25), S(17, 40), S(35, 25)};

Score BISHOP_MOBILITY[14] = {
    S(-18, -21), S(-8, -27), S(5, -11), S(10, -2), S(14, 7),
    S(7, 25), S(14, 22), S(15, 29), S(13, 38), S(17, 29),
    S(18, 34), S(35, 30), S(28, 59), S(60, 35)};

Score ROOK_MOBILITY[15] = {
    S(-24, -22), S(0, -11), S(2, 7), S(-2, 10), S(-6, 19),
    S(3, 28), S(4, 34), S(18, 36), S(25, 41), S(29, 48),
    S(42, 53), S(40, 58), S(45, 74), S(50, 67), S(40, 70)};

Score QUEEN_MOBILITY[28] = {
    S(-24, -48), S(-3, -35), S(5, -16), S(14, -6), S(15, 10),
    S(30, -5), S(27, 20), S(27, 20), S(29, 38), S(34, 31),
    S(30, 42), S(27, 48), S(27, 45), S(35, 37), S(41, 50),
    S(46, 73), S(35, 63), S(47, 74), S(55, 76), S(60, 92),
    S(68, 81), S(58, 91), S(48, 93), S(51, 108), S(56, 103),
    S(50, 103), S(32, 111), S(40, 94)};
