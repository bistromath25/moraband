...
constexpr int CASTLE_RIGHTS[BOARD_SIZE] = {
    14, 15, 15, 12, 15, 15, 15, 13, 15, 15, 15, 15, 15, 15, 15, 15,
    15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15,
    15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15,
    15, 15, 15, 15, 15, 15, 15, 15, 11, 15, 15, 3, 15, 15, 15, 7};

constexpr int GAMESTAGE_SIZE = 2;

enum GameStage { MIDDLEGAME,
                 ENDGAME };
...
inline File file(Square s) { return File(s & 0x7); }
...
inline Rank rank(Square s) { return Rank(s >> 3); }
...
inline PieceType &operator++(PieceType &p) {
    return p = static_cast<PieceType>(static_cast<int>(p) + 1);
}
...
inline int chebyshevDistance(const Square sq1, const Square sq2) {
    return std::max(abs(file(sq1) - file(sq2)), abs(rank(sq1) - rank(sq2)));
}

inline std::string to_string(File f) { return std::string(1, char('h' - f)); }

inline std::string to_string(Rank r) { return std::string(1, char('1' + r)); }
