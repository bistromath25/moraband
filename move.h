...
inline bool noScore(const MoveEntry &entry) { return entry.score == 0; }
...
inline Square getSrc(Move m) { return static_cast<Square>(m & SRC_MASK); }
...
inline bool isPromotion(Move m) { return getPiecePromotion(m); }

inline bool isCastle(Move m) { return m & CASTLE_FLAG; }
